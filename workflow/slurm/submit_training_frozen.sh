...
#SBATCH -t 720
#SBATCH --nodes=1
#SBATCH -o /data1/chaunzt1/stagebridge/runs/logs/training_frozen/fold%a_seed%j.out
#SBATCH -e /data1/chaunzt1/stagebridge/runs/logs/training_frozen/fold%a_seed%j.err
...
OUTPUT_DIR=/data1/chaunzt1/stagebridge/runs/v1_complete/frozen/fold${FOLD}_seed${SEED}
...
mkdir -p /data1/chaunzt1/stagebridge/runs/logs/training_frozen
