...
from stagebridge.preprocessing.harmonize import add_hlca_latent, pca_fit_transform_snrna
...
def build_latent(
    ...
    adata : AnnData
        ...
        layer (see :func:`stagebridge.preprocessing.harmonize.normalize_log1p`).
    method : {"pca", "hlca"}
        ...
        :func:`stagebridge.preprocessing.harmonize.add_hlca_latent`.  If no
    ...
    hlca_reference : HLCAReference or None
        ...
        :func:`stagebridge.io.hlca.load_hlca_reference`.  If ``None`` and
