...
\textbf{[DATA STATISTICS: Report exact cell counts, patient numbers, spot counts, and tissue section numbers after QC.]}
...
\begin{tabular}{lcc}
\toprule
\textbf{Component} & \textbf{Time} & \textbf{Hardware} \\
\midrule
Reference mapping (HLCA) & -- & 4$\times$ H100 GPU \\
Reference mapping (LuCA) & -- & 4$\times$ H100 GPU \\
...
\textbf{[RESULTS: Report actual runtime for each pipeline component. Note early stopping behavior and convergence epochs. Discuss scalability to larger datasets.]}
