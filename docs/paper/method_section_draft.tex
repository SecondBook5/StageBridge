...
\end{equation}
Training proceeds for up to 200 epochs with early stopping on validation ELBO (patience 20). This yields embeddings $z_i^{\text{HLCA}} \in \mathbb{R}^{30}$ and $z_i^{\text{LuCA}} \in \mathbb{R}^{10}$.
