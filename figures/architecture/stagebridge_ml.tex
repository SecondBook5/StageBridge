...
% Arrow a->b
\draw[arraccent] (52, 24) -- (58, 24);

% Arrow b->c
\draw[arraccent] (114, 24) -- (120, 24);

% ============================================
% c) GROMOV-WASSERSTEIN FUSION
% ============================================
\begin{scope}[shift={(120, 24)}]
    \node[panel, minimum width=52mm, minimum height=44mm] at (26, 0) {};
...
\draw[arrthick, draw=refcol!70] (146, 0) -- (146, -16) -| (18, -52);
